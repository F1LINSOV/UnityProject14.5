...
public class LevelBoundary : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 screenResolition;
    ...
    private void Awake()
    {
        ...
        {
            screenResolition.y = Screen.height;
            screenResolition.x = Screen.width;
        }
    }
    ...
    public float RightBorder
    {
        get
        {
            return Camera.main.ScreenToWorldPoint(new Vector3(screenResolition.x, 0, 0)).x;
        }
    }
